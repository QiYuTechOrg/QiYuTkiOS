...
/// 超值大牌商品
struct TbkBrandGoodsListContentView: View {
    let brandId: String

    let logger = Logging.Logger(label: "大牌商品")
    ...
    private func loadingData(
        ...
        let form = ApiDtTbkBrandGoodsForm(brand_id: brandId, page_id: pid)
        ApiTbkDtkBrandGoodsStub.my_post(args: form, failure_cb: {
